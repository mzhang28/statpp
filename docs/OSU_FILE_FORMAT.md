...
The first line of the file specifies the file format version. For example, `osu file format v14` is the latest version. (v128 for [osu!(lazer)](/wiki/Client/Release_stream/Lazer).)
...
_Background syntax:_ `0,0,filename,xOffset,yOffset`
...
_Video syntax:_ `Video,startTime,filename,xOffset,yOffset`
...
_Break syntax:_ `2,startTime,endTime`
...
_For information about storyboard syntax, see [Storyboard Scripting](/wiki/Storyboard/Scripting)._
...
_Timing point syntax:_ `time,beatLength,meter,sampleSet,sampleIndex,volume,uninherited,effects`
...
_Hit object syntax:_ `x,y,time,type,hitSound,objectParams,hitSample`
...
_Hit sample syntax:_ `normalSet:additionSet:index:volume:filename`
...
_Slider syntax:_ `x,y,time,type,hitSound,curveType|curvePoints,slides,length,edgeSounds,edgeSets,hitSample`
...
_Spinner syntax:_ `x,y,time,type,hitSound,endTime,hitSample`
...
_Hold syntax:_ `x,y,time,type,hitSound,endTime:hitSample`
